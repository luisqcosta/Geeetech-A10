...
#define STRING_CONFIG_H_AUTHOR "(LMO, Geeetech A10 Titan Aero TMC2208 Standalone)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3D Titan9"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 500, 3000 }
...
#define INVERT_E0_DIR true // False with Allegro Driver, True with TMC22XX and wantai motor (special wiring)
#define INVERT_E1_DIR true  // If you think you need annother extruder in the A10, use TMC and set to true
